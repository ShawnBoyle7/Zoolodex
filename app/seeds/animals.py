...
def seed_animals():
    ...
    animals.append(Animal(group="Mammal", family="Felidae", species="Tiger", sub_species="Siberian Tiger", img_url="https://i.imgur.com/gYPeIbS.jpg", origins=faker.paragraph(nb_sentences=180), traits=faker.paragraph(nb_sentences=180), ecosystem_influence=faker.paragraph(nb_sentences=180)))
