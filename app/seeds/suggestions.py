...
def seed_suggestions():
    ...
    suggestions.append(Suggestion(type="region", title="Drake Passage", description=faker.text(300), img_url="https://i.imgur.com/yTc1tgS.png", user_id=1))

    suggestions.append(Suggestion(type="region", title="Llanos Grasslands", description=faker.text(300), img_url="https://i.imgur.com/1bppcnu.jpeg", user_id=1))
    ...
    suggestions.append(Suggestion(type="region", title="Kaziranga National Park", description=faker.text(300), img_url="https://i.imgur.com/1Wrqj1M.jpeg", user_id=1))

    suggestions.append(Suggestion(type="region", title="The Ngorongoro Crater", description=faker.text(300), img_url="https://i.imgur.com/afxqRVh.jpeg", user_id=1))

    suggestions.append(Suggestion(type="region", title="Okavango Delta", description=faker.text(300), img_url="https://i.imgur.com/qP861M6.jpeg", user_id=2))
    ...
    suggestions.append(Suggestion(type="region", title="Sabi Sands Game Reserve", description=faker.text(300), img_url="https://i.imgur.com/wcF66cn.jpeg", user_id=3))
