...
Revision ID: 130980ee40c1
Revises: 
Create Date: 2021-09-30 10:13:18.901017
...
def upgrade():
    ...
    sa.Column('sub_species', sa.String(length=50), nullable=False),
    sa.Column('img_url', sa.String(length=255), nullable=False),
    sa.Column('origins', sa.String(length=10000), nullable=False),
    sa.Column('traits', sa.String(length=10000), nullable=False),
    sa.Column('ecosystem_influence', sa.String(length=10000), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('img_url_1', sa.String(length=255), nullable=True),
    sa.Column('img_url_2', sa.String(length=255), nullable=True),
    sa.Column('img_url_3', sa.String(length=255), nullable=True),
    sa.Column('img_url_4', sa.String(length=255), nullable=True),
    sa.Column('img_url_5', sa.String(length=255), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
